...
int main(int argc, char** argv) {
    ...
    const mcl::Vint g("5"); int num = 16; mcl::Vint n = mcl::Vint(1)<<num, alpha_vint;
    ...
    auto shared_x = L2A_mascot::L2A(elgl,lvt,mascot,party,num_party,io,&pool,x,vec_cx,FIELD_SIZE);
