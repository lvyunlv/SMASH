...
int main(int argc, char** argv){
    ...
    if(argc<5){ cout<<"Usage: <party> <port> <num_party> <network_condition> [ip_config_file]"<<endl; return 0; }
    ...
    for(int i=0;i<times;i++){
        auto [x, vec_cx] = A2L_spdz2k::A2L(elgl,lvt,spdz2k,party,num_party,io,&pool,shared_x,FIELD_SIZE,online_time,online_comm,is_wan);
